	...
	public static void main(String[] args) {
		...
		if (!seg2.equals(seg3)) {
			System.out.println("\t ERROR - equals - seg2.equals(seg3)? - expected true ; actual="
							+ seg2.equals(seg3) + " seg2: " + seg2 + " seg3: " + seg3);
		} else
       ...
       seg0.changeSize(-2);
		...
		seg0 = new Segment2(1,7,5,7);
		seg1 = new Segment2(8,2,11,2);
        ...
        seg0 = new Segment2(10,7,20,7);
		seg1 = new Segment2(13,11,17,11);
      ...
      //degenerated rectangle
        ...
        //square
        seg0 = new Segment2(5, 5, 10, 5);
		seg1 = new Segment2(5, 10, 10, 10);
        if (seg0.trapezePerimeter(seg1) != 20) {
            System.out.println("\t ERROR - seg0.trapezePerimeter(seg1) - expected 20.0 ; actual="
        ...
        seg0 = new Segment2(14,6,14,6);
		seg1 = new Segment2(11,10,17,10);
        ...
        //triangle (one degenerated segment)
        seg1 = new Segment2(14,7,14,7);
		seg0 = new Segment2(10,10,18,10);
